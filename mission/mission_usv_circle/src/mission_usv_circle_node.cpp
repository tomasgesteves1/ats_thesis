...
MissionUsvCircleNode::MissionUsvCircleNode() 
    : Node("usv_trajectory_circle_node") 
{
    ...
    pipeline_ = std::make_unique<MissionUsvCirclePipeline>();
    ...
    timer_ = this->create_wall_timer(
        ...
        std::bind(&MissionUsvCircleNode::timerCallback, this)
    );

    RCLCPP_INFO(this->get_logger(), "Mission USV Circle Node initialized.");
}

void MissionUsvCircleNode::timerCallback() {
