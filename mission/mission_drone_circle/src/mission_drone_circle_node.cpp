...
MissionDroneCircleNode::MissionDroneCircleNode() 
    : Node("uav_trajectory_circle_node") 
{
    ...
    pipeline_ = std::make_unique<MissionDroneCirclePipeline>();
    ...
    timer_ = this->create_wall_timer(
        ...
        std::bind(&MissionDroneCircleNode::timerCallback, this)
    );

    RCLCPP_INFO(this->get_logger(), "Mission Drone Circle Node initialized.");
}

void MissionDroneCircleNode::timerCallback() {
