...
\begin{itemize}
    ...
    \item \textbf{Chapter 3 (System Modeling)} derives the kinematic and dynamic models of both vehicles, as well as the coupling tether and winch formulations.
    \item \textbf{Chapter 4 (Cooperative Control Design)} details the decentralized NMPC mathematical formulation, cost functions, physical constraints, and winch spooling control laws.
    \item \textbf{Chapter 5 (Simulation Environment and Software Implementation)} introduces the physical characteristics of the virtual WAM-V and x500 platforms, the simulation setup, and the software modularity.
