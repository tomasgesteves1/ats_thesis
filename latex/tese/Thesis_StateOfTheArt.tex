...
\subsection{Related Work on Tethered Vehicle Modeling}
...
\begin{itemize}
    \item \textbf{Passive Tension Tethers:} Rely on spring-loaded spools or constant-torque slip rings. While simple and requiring no electrical control, they cannot adapt to fast vessel manoeuvres, leading to large tension spikes or excessive slack.
